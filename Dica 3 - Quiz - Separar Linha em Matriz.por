programa
{
	...
	funcao inicio()
	{
		cadeia nomes[30][2] //30 nomes com nome em uma coluna e sobre nome na outra
		inteiro qtdNomes = 0

		qtdNomes = separaNomes(nomes)
	 ...
	 */
	funcao inteiro separaNomes(cadeia nm[][]) {
		...
		enquanto(nao arq.fim_arquivo(refArq)) {
			...
			se(txt.numero_caracteres(linha) != 0) {
				...
				//pega o nome
				nm[pos][0] = txt.extrair_subtexto(linha, 0, hashtag)
				nm[pos][1] = txt.extrair_subtexto(linha, hashtag+1, tamanho)
